...
Rectangle {
    ...
    function playIndex(index){
        ...
        var music = playlistView.model.getMusic(playlistView.currentIndex);
        curMusic = music;
    }
    ...
    function addMusics(index, musics, songSheetId){
        playlistView.model.addMusics(musics, songSheetId);
        playIndex(index);
    }
    ...
    ListView {
        ...
        Component.onCompleted: {
            playlistView.model = modelContainer.get("playlistModel");
            playlistView.model.loadPlaylist();
