...
ListView {
    ...
    function search(musicSrc, keyword){
        networkongListView.model.getNetworkMusics(musicSrc, keyword);
    }
    ...
    function playIndex(index){
        ...
        addToPlaylist(0, networkongListView.model.getMusics(networkongListView.selectedItems), networkongListView.songSheetId);
    }
    ...
    function searchLast(){
        model.getLastPageMusic();
    }

    function searchNext(){
        model.getNextPageMusic();
    }
    ...
    model: modelContainer.get("networkMusicModel")
