...
class McAbstractMusic : public QObject, public IMcMusicApi {
    ...
    MC_TYPELIST(QObject, IMcMusicApi)
public:
    ...
    QString getDownloadUrl(McMusicConstPtrRef music) noexcept override final;
...
protected:
    ...
    virtual QString getDownloadLink(McMusicConstPtrRef music) noexcept = 0;
